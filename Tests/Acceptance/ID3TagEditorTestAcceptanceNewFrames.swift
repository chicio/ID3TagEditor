...
//        XCTAssertEqual((id3Tag?.frames[.InvolvedPeople] as? ID3FrameCreditsList)?.entries, [("Producer", "Producer Name"), ("Director", "Director Name")])
    ...
    func testReadNewFramesV3() throws {
        let path = PathLoader().pathFor(name: "example-newframes-v3-written", fileType: "mp3") //"/Users/nolainecrusher/Downloads/audiobook_tools/sampleaax/mp3-yate.mp3"
...
//        XCTAssertEqual((id3Tag?.frames[.InvolvedPeople] as? ID3FrameCreditsList)?.entries, [("Director", "Director Name"), ("Producer", "Producer Name")])
    ...
    func testReadNewFramesV4() throws {
        ...
        XCTAssertEqual((id3Tag?.frames[.AudioSourceUrl] as? ID3FrameWithStringContent)?.content, "http://AudioSourceUrl.com")
        XCTAssertEqual((id3Tag?.frames[.BPM] as? ID3FrameWithIntegerContent)?.id3Identifier, "TBPM")
        XCTAssertEqual((id3Tag?.frames[.BPM] as? ID3FrameWithIntegerContent)?.value, 99)
    ...
    func testWriteNewFramesV2() throws {
        ...
        let id3Tag = ID3Tag(
            ...
            frames: [
                ...
                .InvolvedPeople : ID3FrameCreditsList(entries: [(role: "Producer", person: "Producer Name")]),
