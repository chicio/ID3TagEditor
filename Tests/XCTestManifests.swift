...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(ID3UnsynchronisedLyricForLanguageFrameCreatorTest.allTests),
        testCase(ID3UnsyncronizedLyricsFrameCreatorTest.allTests),
        testCase(ID3FrameHeaderCreatorTest.allTests),
        testCase(ID3UnsynchronisedLyricsFrameContentParsingOperationTest.allTests),
