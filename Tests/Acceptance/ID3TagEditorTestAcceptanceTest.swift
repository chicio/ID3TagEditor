...
class ID3TagEditorTest: XCTestCase {
    ...
    func testReadTagV2() {
        ...
        XCTAssertEqual((id3Tag?.frames[.AlbumArtist] as? ID3FrameWithStringContent)?.id3Identifier, "TP2")
        XCTAssertEqual((id3Tag?.frames[.AlbumArtist] as? ID3FrameWithStringContent)?.content, "example album artist")
        XCTAssertEqual((id3Tag?.frames[.Artist] as? ID3FrameWithStringContent)?.id3Identifier, "TP1")
        XCTAssertEqual((id3Tag?.frames[.Artist] as? ID3FrameWithStringContent)?.content, "example artist")
        XCTAssertEqual((id3Tag?.frames[.AttachedPicture(.FrontCover)] as? ID3FrameAttachedPicture)?.id3Identifier, "PIC")
    ...
    func testParseTagV3AdditionalData() {
        ...
        XCTAssertEqual((id3Tag?.frames[.Artist] as? ID3FrameWithStringContent)?.content, "A New Artist")
        XCTAssertEqual((id3Tag?.frames[.AlbumArtist] as? ID3FrameWithStringContent)?.id3Identifier, "TPE2")
        XCTAssertEqual((id3Tag?.frames[.AlbumArtist] as? ID3FrameWithStringContent)?.content, "A New Album Artist")
        XCTAssertEqual((id3Tag?.frames[.AttachedPicture(.FrontCover)] as? ID3FrameAttachedPicture)?.id3Identifier, "APIC")
        XCTAssertEqual((id3Tag?.frames[.AttachedPicture(.FrontCover)] as? ID3FrameAttachedPicture)?.picture, coverFront)
        XCTAssertEqual((id3Tag?.frames[.AttachedPicture(.FrontCover)] as? ID3FrameAttachedPicture)?.type, .FrontCover)
        XCTAssertEqual((id3Tag?.frames[.AttachedPicture(.FrontCover)] as? ID3FrameAttachedPicture)?.format, .Jpeg)
        XCTAssertEqual((id3Tag?.frames[.AttachedPicture(.BackCover)] as? ID3FrameAttachedPicture)?.id3Identifier, "APIC")
        ...
        XCTAssertEqual((id3Tag?.frames[.Genre] as? ID3FrameGenre)?.id3Identifier, "TCON")
        ...
        XCTAssertEqual((id3Tag?.frames[.TrackPosition] as? ID3FrameTrackPosition)?.id3Identifier, "TRCK")
        ...
        XCTAssertEqual((id3Tag?.frames[.RecordingDayMonth] as? ID3FrameRecordingDayMonth)?.id3Identifier, "TDAT")
        ...
        XCTAssertEqual((id3Tag?.frames[.RecordingYear] as? ID3FrameRecordingYear)?.id3Identifier, "TYER")
        XCTAssertEqual((id3Tag?.frames[.RecordingYear] as? ID3FrameRecordingYear)?.year, 2018)
        XCTAssertEqual((id3Tag?.frames[.RecordingHourMinute] as? ID3FrameRecordingHourMinute)?.id3Identifier, "TIME")
