...
public class ID3Tag: CustomDebugStringConvertible {
    ...
    public var debugDescription: String {
        ...
        - comment: \((self.frames[.Comment] as? ID3FrameWithStringContent)?.content ?? "-")
        ...
        - grouping: \((self.frames[.Grouping] as? ID3FrameWithStringContent)?.content ?? "-")
        ...
        - movementIndex: \((self.frames[.MovementIndex] as? ID3FrameMovementIndex)?.debugDescription ?? "-")
        - movementName: \((self.frames[.MovementName] as? ID3FrameWithStringContent)?.content ?? "-")
