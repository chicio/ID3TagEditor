...
class ID3TagEditorTestAcceptanceNewFrames: XCTestCase {
    ...
    func testReadNewFramesV2() {
        ...
        //XCTAssertEqual(id3Tag?.frames[.Composer]?.size, 35)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Conductor]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.ContentGrouping]?.size, 51)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Copyright]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.EncodedBy]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.EncoderSettings]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.FileType]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Lyricist]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.MediaType]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.MixArtist]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Publisher]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Subtitle]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.UnsyncedLyrics]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.DiscPosition]?.size, 15)
        ...
        XCTAssertEqual(id3Tag?.frames[.SeriesIndex]?.id3Identifier, "TXX")
        //XCTAssertEqual(id3Tag?.frames[.SeriesIndex]?.size, 15)
    ...
    func testReadNewFramesV3() {
        ...
        //XCTAssertEqual(id3Tag?.frames[.Composer]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.EncodedBy]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.EncoderSettings]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.ITunesGrouping]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Lyricist]?.size, 51)
        ...
        //XCTAssertEqual(id3Tag?.frames[.MediaType]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.MixArtist]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.FileOwner]?.size, 51)
        XCTAssertEqual((id3Tag?.frames[.FileOwner] as? ID3FrameWithStringContent)?.content, "FileOwner V3")
        XCTAssertEqual(id3Tag?.frames[.MovementName]?.id3Identifier, "MVNM")
        //XCTAssertEqual(id3Tag?.frames[.MovementName]?.size, 37)
        XCTAssertEqual((id3Tag?.frames[.MovementName] as? ID3FrameWithStringContent)?.content, "MovementName V3")
        XCTAssertEqual(id3Tag?.frames[.MovementIndex]?.id3Identifier, "MVIN")
        //XCTAssertEqual(id3Tag?.frames[.MovementIndex]?.size, 15)
        ...
        //XCTAssertEqual(id3Tag?.frames[.PodcastCategory]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.PodcastDescription]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.PodcastID]?.size, 51)
        ...
        //XCTAssertEqual(id3Tag?.frames[.PodcastKeywords]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Publisher]?.size, 37)
        XCTAssertEqual((id3Tag?.frames[.Publisher] as? ID3FrameWithStringContent)?.content, "Publisher V3")
        XCTAssertEqual(id3Tag?.frames[.SeriesIndex]?.id3Identifier, "TXXX")
        //XCTAssertEqual(id3Tag?.frames[.SeriesIndex]?.size, 15)
        XCTAssertEqual((id3Tag?.frames[.SeriesIndex] as? ID3FrameSeriesIndex)?.index, 11)
        XCTAssertEqual((id3Tag?.frames[.SeriesIndex] as? ID3FrameSeriesIndex)?.totalBooks, 19)
        ...
        //XCTAssertEqual(id3Tag?.frames[.UnsyncedLyrics]?.size, 51)
    ...
    func testReadNewFramesV4() {
        ...
        //XCTAssertEqual(id3Tag?.frames[.ContentGrouping]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.FileOwner]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.FileType]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Lyricist]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.MovementName]?.size, 37)
        XCTAssertEqual((id3Tag?.frames[.MovementName] as? ID3FrameWithStringContent)?.id3Identifier, "MVNM")
        XCTAssertEqual((id3Tag?.frames[.MovementName] as? ID3FrameWithStringContent)?.content, "MovementName V4")
        //XCTAssertEqual(id3Tag?.frames[.PodcastCategory]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.PodcastDescription]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.PodcastID]?.size, 37)
        ...
        //XCTAssertEqual(id3Tag?.frames[.PodcastKeywords]?.size, 39)
        ...
        //XCTAssertEqual(id3Tag?.frames[.Subtitle]?.size, 37)
    ...
    func testWriteNewFramesV4() {
        ...
        let id3Tag = ID3Tag(
            ...
            frames: [
                ...
                .MovementName : ID3FrameWithStringContent(content: "MovementName V4"),
                .MovementIndex : ID3FrameDiscPosition(position: 6, totalDiscs: 13),
